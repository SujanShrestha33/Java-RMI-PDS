...
public class Purchase extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/purchase.png"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (model.getRowCount() > 0) {
            try {
                ...
                value = client.getRemote3Service().getUserValue(email);
                ...
                for (int i = 0; i < model.getRowCount(); i++) {
                    ...
                    client.getRemote3Service().insertPurchase(id, uid, uname, uPhone, pid, pName, q, pri, tot, purchaseDate, address, null, null, "Pending");
                    int newQuantity = client.getRemote3Service().getProductQty(pid) - q;
                    client.getRemote3Service().qtyUpdate(pid, newQuantity);
                }
                
                statistics.user(client.getRemoteService().getUserId(email));
                JOptionPane.showMessageDialog(this, "Successfully purchased", "Success", 1);
